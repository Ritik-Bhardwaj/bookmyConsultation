...
public class DoctorService {
	...
	public Doctor register(Doctor doctor) throws InvalidInputException{
		...
		if (doctor.getSpeciality().equals(null))
	...
	public Doctor getDoctor(String id){
			...
			Optional<Doctor> optionalDoctorValue = Optional.ofNullable(doctorRepository.findById(id).get());

			Doctor doctor = optionalDoctorValue.orElseThrow(() -> new ResourceUnAvailableException());
